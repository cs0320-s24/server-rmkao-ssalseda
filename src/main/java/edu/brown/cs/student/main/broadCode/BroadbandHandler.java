...
//    } catch (Exception e) {
//      e.printStackTrace();
//      // This is a relatively unhelpful exception message. An important part of this sprint will
// be
//      // in learning to debug correctly by creating your own informative error messages where
// Spark
//      // falls short.
...
//
//    // What's the difference between these two lines? Why do we return the body? What is useful
// from
