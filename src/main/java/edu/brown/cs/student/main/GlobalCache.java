 ...
 *              files preserved in the cache). This particular cache is populated by search terms
 *              and their corresponding responseMaps which can be quickly dispensed instead of
 *              necessitating a long call to the ACS.
 */
public class GlobalCache {
  public Cache<String, Map<String, Object>> cache;

  /**
   * The constructor sets the basics for the cache and allows for user modifications.
   * There are a variety of other limits that users can configure here, but we thought these to be
   * the most useful without going overboard
   */
  public GlobalCache() {
